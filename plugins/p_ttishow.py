...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('Support', url=f'https://t.me/+tDGEI-d6mwgyMTI1')
            ]]
            ...
            return
        buttons = [[[
            InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url='https://t.me/Filmydosesofficial'),
            InlineKeyboardButton('Uᴘᴅᴀᴛᴇs Cʜᴀɴɴᴇʟ', url='https://t.me/Filmy_Doses')
        ],[
            InlineKeyboardButton("Bᴏᴛ Oᴡɴᴇʀ", url='https://t.me/FilmyDosesbot')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def disable_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('Support', url=f'https://t.me/Filmydosesofficial}')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        await bot.send_message(
            chat_id=chat_, 
