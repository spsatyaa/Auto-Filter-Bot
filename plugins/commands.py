...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
            ...
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url=f'https://t.me/+tDGEI-d6mwgyMTI1'),
            InlineKeyboardButton('ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ', url='https://t.me/Filmydosesofficial')
        ],[
            InlineKeyboardButton('ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/Filmy_Doses')
    ...
    if len(message.command) != 2:
        if PREMIUM_AND_REFERAL_MODE == True:
            buttons = [[
                ...
                InlineKeyboardButton('🔥YouTube🔥', Url="https://youtube.com/@filmydoses?feature=shared"),
                InlineKeyboardButton('🤖 Instagram 🤖', url='https://www.instagram.com/filmy._.doses?igsh=MXdqeWw3MTZiZTkwZA==')
            ],[
                InlineKeyboardButton('Main Channel ', Url='https://t.me/Filmy_Doses'),
                InlineKeyboardButton('Contact Us', Url='https://t.me/FilmyDosesbot')
            ],[
                InlineKeyboardButton('ᴘʀᴇᴍɪᴜᴍ ᴀɴᴅ ʀᴇғᴇʀʀᴀʟ', Url='https://t.me/FilmyDosesbot')
            ],[
                InlineKeyboardButton('ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ', url='https://t.me/FilmyDosesbot')
            ]]
        else:
            buttons = [[
                InlineKeyboardButton('⤬ ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ⤬', url=f'http://t.me/{temp.U_NAME}?startgroup=true')
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        try:
            ...
            return
        try:
            btn = [[InlineKeyboardButton("ʙᴀᴄᴋᴜᴘ ᴄʜᴀɴɴᴇʟ", url='https://t.me/Filmy_Doses')]]
            ...
            if REQUEST_TO_JOIN_MODE == True:
                if TRY_AGAIN_BTN == True:
                    text = "**🕵️Bhai Pehle Back Up Channel Join Karle Uske Bad Hi Movie Dunga**"
                else:
                    await db.set_msg_command(message.from_user.id, com=message.command[1])
                    text = "**🕵️ Bhai Pehle Back Up Channel Join Karle Uske Bad Hi Movie Dunga**"
            else:
                text = "**🕵️ Bhai Pehle Back Up Channel Join Karle Uske Bad Hi Movie Dunga**"
    ...
    if data.split("-", 1)[0] == "BATCH":
        sts = await message.reply("<b>Sabra Rakh...</b>")
